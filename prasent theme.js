...
// EOC
	var addUncheckButton = function(parameterBody) {
		...
		btn.setButtonState = function() {
			...
			//btn.textContent = (btn.checkboxesChecked) ? 'ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œ' : 'ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“';
		}
		...
		$('#j_username').each(function(){
			...
			$.on(this, 'change', function() {
				...
				if (login.length && login[0].toLowerCase() === login[0]) {
					alert('Login MUSI byÃƒÆ’Ã¢â‚¬Å¾ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ wpisany z duÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¼ej litery!'
						+'\n\nInaczej nie bÃƒÆ’Ã¢â‚¬Å¾ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢dziesz mieÃƒÆ’Ã¢â‚¬Å¾ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ normalnych uprawnieÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾.'
						+'\n\nPrzykÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ad: jÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³zefk - ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Âºle, JÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³zefK - dobrze.'
					);
				}
			});

			var el = document.createElement('span');
			el.textContent = ' Login MUSI byÃƒÆ’Ã¢â‚¬Å¾ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ wpisany z duÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¼ej litery (jÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³zefk - ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Âºle, JÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³zefK - dobrze).';
